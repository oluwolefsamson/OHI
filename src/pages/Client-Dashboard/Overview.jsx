    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        {editableItems.map((item) => (
          <Card
            key={item.title}
            className="group border-border/80 bg-card/90 shadow-[0_16px_50px_rgba(15,23,42,0.06)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_20px_60px_rgba(15,23,42,0.1)]"
          >
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
        <Card className="border-border/80 bg-card/95 shadow-[0_18px_50px_rgba(15,23,42,0.08)] backdrop-blur">
          <CardHeader>
            <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-muted-foreground">
              Editor scope
            </p>
