        ...
        <div className="flex justify-end">
          <Card className="w-full overflow-hidden border-white/15 bg-white/10 shadow-[0_28px_80px_rgba(15,23,42,0.2)] backdrop-blur-md lg:w-1/2 lg:max-w-[640px] lg:flex-none lg:ml-auto">
            <div className="relative h-[520px] overflow-hidden bg-[#dbeafe]">
              ...
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(15,76,129,0.12),transparent_24%),radial-gradient(circle_at_bottom_right,rgba(245,158,11,0.08),transparent_20%)]" />
              ...
              <div className="pointer-events-none absolute left-[52%] top-[48%] flex -translate-x-1/2 -translate-y-1/2 flex-col items-center">
                <div className="relative flex h-16 w-16 items-center justify-center">
                  <div className="absolute h-16 w-16 rounded-full bg-[#0f4c81]/18 animate-pulse" />
                  <div className="relative flex h-12 w-12 items-center justify-center rounded-full border-4 border-white bg-[#0f4c81] shadow-[0_18px_45px_rgba(15,76,129,0.38)]">
                    <div className="h-3.5 w-3.5 rounded-full bg-[#f59e0b]" />
                  </div>
                </div>
                <div className="mt-3 rounded-full border border-white/35 bg-white/90 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-slate-700 shadow-sm">
                  OHI Office
                </div>
              </div>
              ...
              <div className="absolute bottom-5 left-5 max-w-[240px] rounded-2xl border border-white/20 bg-white/90 px-4 py-3 text-sm text-slate-700 shadow-[0_18px_45px_rgba(15,23,42,0.18)] backdrop-blur-md">
                <p className="font-semibold text-slate-900">Open in Maps</p>
                <p className="mt-1 text-xs text-slate-500">
                  Locate the office and plan your visit.
                </p>
              </div>

              <div className="absolute bottom-5 right-5 rounded-2xl border border-white/20 bg-white/90 px-4 py-3 text-xs text-slate-600 shadow-[0_18px_45px_rgba(15,23,42,0.18)] backdrop-blur-md">
