...
const profileHighlights = [
  ...
  },
  {
    ...
    description:
      "The content speaks to donors, institutions, and partners who need credible communication.",
  },
  {
  ...
  return (
    ...
    >
      <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="rounded-[32px] border border-[#D9DCE2] bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {profileStats.map((stat) => (
              <div
                key={stat.label}
                className="rounded-[24px] border border-[#E5E7EB] bg-[#F8FAFC] p-4"
              >
        ...
        <div className="rounded-[32px] border border-[#D9DCE2] bg-[linear-gradient(180deg,#0f172a_0%,#13283c_100%)] p-6 text-white shadow-sm sm:p-8">
      ...
      <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        {profilePages.map((page, index) => {
          return (
            <Card
              key={page.path}
              className="group overflow-hidden border-[#D9DCE2] bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#c9ced7] hover:shadow-[0_24px_70px_rgba(15,23,42,0.12)]"
            >
      ...
      <section
        id="clients"
        className="mt-16 rounded-[32px] border border-[#D9DCE2] bg-white p-6 shadow-sm sm:p-8"
      >
        <SectionHeader
          title="Our Clients"
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-[24px] bg-[#f8fafc] p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-textColor">
              Logos are shown as part of a broader proof strip, not an isolated
              gallery.
            </p>
          </div>
          <div className="rounded-[24px] bg-[#f8fafc] p-4">
